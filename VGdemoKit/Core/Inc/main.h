...
#define Radio_LNA_EN_Pin GPIO_PIN_10
#define Radio_LNA_EN_GPIO_Port GPIOB
#define Radio_PA_EN_Pin GPIO_PIN_11
#define Radio_PA_EN_GPIO_Port GPIOB
#define Board_Buzzer_Pin GPIO_PIN_12
#define Board_Buzzer_GPIO_Port GPIOA
#define Radio_Reset_SUB_Pin GPIO_PIN_4
#define Radio_Reset_SUB_GPIO_Port GPIOB
#define Radio_DIO1_SUB_Pin GPIO_PIN_5
#define Radio_DIO1_SUB_GPIO_Port GPIOB
#define Radio_Busy_SUB_Pin GPIO_PIN_6
#define Radio_Busy_SUB_GPIO_Port GPIOB
#define Radio_NSS_SUB_Pin GPIO_PIN_7
#define Radio_NSS_SUB_GPIO_Port GPIOB
